...
class ICTCurriculumSeeder extends Seeder
{
    ...
    {
        // Get the ICT program
        $program = Program::where('program_code', 'ICT')
        ...
        // Create curriculum for ICT 2025
        $curriculum = Curriculum::updateOrCreate(
            [
                'program_id' => $program->id,
                'curriculum_name' => 'ICT 2025 Curriculum',
            ],
            [
                'curriculum_code' => 'ICT-2025',
                'description' => 'Information Communication Technology curriculum focusing on programming and computer systems',
                'status' => 'active',
                'is_current' => true,
            ]
        );

        // Define all subjects for ICT
        $subjects = [
            ...
            // Grade 11 - First Semester - Applied Subjects
            ['code' => 'PROG 110', 'name' => 'Programming NC III', 'type' => 'applied', 'units' => 3, 'year' => 11, 'semester' => 1],
            ...
            ['code' => 'PROG 120', 'name' => 'Programming NC III', 'type' => 'specialized', 'units' => 3, 'year' => 11, 'semester' => 2],
            ...
            ['code' => 'CHS 210', 'name' => 'Computer Hardware Servicing NC II', 'type' => 'specialized', 'units' => 3, 'year' => 12, 'semester' => 1],
            ...
            ['code' => 'ANI', 'name' => 'Animation', 'type' => 'specialized', 'units' => 3, 'year' => 12, 'semester' => 2],
