...
class HomeEconomicsCurriculumSeeder extends Seeder
{
    ...
    {
        // Get the Home Economics program
        $program = Program::where('program_code', 'HE')
        ...
        // Create curriculum for Home Economics 2025
        $curriculum = Curriculum::updateOrCreate(
            [
                'program_id' => $program->id,
                'curriculum_name' => 'Home Economics 2025 Curriculum',
            ],
            [
                'curriculum_code' => 'HE-2025',
                'description' => 'Home Economics curriculum focusing on cookery, bread and pastry, and food service',
                'status' => 'active',
                'is_current' => true,
            ]
        );

        // Define all subjects for Home Economics
        $subjects = [
            ...
            ['code' => 'CKRY 110', 'name' => 'Cookery NC II', 'type' => 'specialized', 'units' => 3, 'year' => 11, 'semester' => 1],
            ...
            ['code' => 'CKRY 120', 'name' => 'Cookery 2 NC II', 'type' => 'specialized', 'units' => 3, 'year' => 11, 'semester' => 2],
            ...
            ['code' => 'BAP 210', 'name' => 'Bread and Pastry Production NC II', 'type' => 'specialized', 'units' => 3, 'year' => 12, 'semester' => 1],
            ...
            ['code' => 'FAB', 'name' => 'Food and Beverage Services NC II', 'type' => 'specialized', 'units' => 3, 'year' => 12, 'semester' => 2],
            ['code' => 'WORK-IMM', 'name' => 'Work Immersion', 'type' => 'specialized', 'units' => 2, 'year' => 12, 'semester' => 2],
        ];
