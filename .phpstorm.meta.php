...
'inertia.testing.page_extensions','inertia.history.encrypt','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains',
...
'boost.browser-logs','sanctum.csrf-cookie','test.index','test.store','test.show','test.update',
'test.destroy','dashboard','profile.edit',
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','MYSQL_EXTRA_OPTIONS',
