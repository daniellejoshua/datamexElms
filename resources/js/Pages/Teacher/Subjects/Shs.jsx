        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-gray-900">My SHS Subjects</h2>
                        <p className="text-sm text-gray-600 mt-1">Manage grades and students for your senior high school subjects</p>
                    </div>
                </div>
            }
        >
