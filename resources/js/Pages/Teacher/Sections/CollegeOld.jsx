                                        ...
                                        {section.teacher_subjects && section.teacher_subjects.length > 0 && (
                                            <div className="space-y-2">
                                                {section.teacher_subjects.map((teacherSubject, index) => (
                                                    <Card key={teacherSubject.id} className="p-3 bg-gradient-to-r from-orange-50 to-yellow-50 border border-orange-200">
                                                        <div className="flex items-start text-sm">
                                                            <BookOpen className="w-4 h-4 text-orange-600 mr-3 flex-shrink-0 mt-0.5" />
                                                            <div className="flex-1 min-w-0">
                                                                ...
                                                                {/* Schedule and Room for this subject */}
