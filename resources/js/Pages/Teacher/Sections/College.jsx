            ...
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">View and manage your assigned sections</p>
                    </div>
                </div>
            }
        >
                                                ...
                                                <div className="space-y-3">
                                                    {section.teacher_subjects && section.teacher_subjects.length > 0 ? (
                                                        section.teacher_subjects.map((teacherSubject) => (
                                                            <div key={teacherSubject.id} className="bg-gradient-to-r from-gray-50 to-blue-50 border border-blue-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                                                        ...
                                                                        <div className="space-y-1.5">
                                                                            ...
                                                                            {teacherSubject.room && (
                                                                                <div className="flex items-center text-xs text-gray-600">
                                                                                    ...
                                                                                    <span>Room {teacherSubject.room}</span>
                                                                                </div>
                                                                            )}
                                                                        </div>
                                                                    </div>
                                                                    <div className="flex flex-col gap-2 flex-shrink-0">
                                                                        <Link href={route('teacher.grades.show', teacherSubject.id)}>
                                                                            <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white w-full min-w-[110px]">
                                                                                <BarChart3 className="w-3.5 h-3.5 mr-1.5" />
                                                                                Manage Grades
                                                                            </Button>
                                                                        </Link>
                                                                        <Link href={route('teacher.materials.index', teacherSubject.id)}>
                                                                            <Button size="sm" variant="outline" className="border-green-300 text-green-700 hover:bg-green-50 w-full min-w-[110px]">
