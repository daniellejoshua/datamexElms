...
const CarryForward = ({ archivedSections, currentAcademicPeriod, previousSemester }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.shs.sections.carry-forward'));
    };
            ...
            header={
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900">Carry Forward SHS Section</h2>
                            <p className="text-sm text-purple-600 font-medium mt-1">Create new section from previous semester</p>
                        </div>
                    </div>
                </div>
            }
        >
            <Head title="Carry Forward SHS Section" />
