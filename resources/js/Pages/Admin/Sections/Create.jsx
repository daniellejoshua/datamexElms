...
const Create = ({ programs }) => {
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        section_name: '',
        year_level: 1,
        academic_year: currentAcademicYear, // Default to current academic year
        semester: getCurrentSemester(), // Default to current semester
        status: 'active'
    });
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-blue-600 font-medium mt-1">Add a new academic section</p>
                        </div>
                    </div>
                </div>
            }
                ...
                <div className="max-w-2xl mx-auto">
                    <Card className="shadow-lg">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Create a new section for students to enroll in specific academic programs
                            </CardDescription>
                        </CardHeader>
